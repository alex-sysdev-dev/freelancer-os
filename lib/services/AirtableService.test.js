...
describe('sortByDateAsc', () => {
  it('sorts records from oldest to newest', () => {
    ...
    expect(sorted[0].dateObj.getMonth()).toBe(0) // January
    expect(sorted[1].dateObj.getMonth()).toBe(1) // February
    expect(sorted[2].dateObj.getMonth()).toBe(2) // March
  })
...
describe('sortByDateDesc', () => {
  it('sorts records from newest to oldest', () => {
    ...
    expect(sorted[0].dateObj.getMonth()).toBe(2) // March
    expect(sorted[2].dateObj.getMonth()).toBe(0) // January
  })
})
