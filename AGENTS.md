# AGENTS.md — Freelancer Finance OS
...
# Codex Chat (optional)
ANTHROPIC_API_KEY=                 # Anthropic API key for Codex chat (server-side only)
ANTHROPIC_MODEL=Codex-3-haiku-20240307  # Optional Codex model override
```
